    ...
    <!-- Navigation -->
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header" align="center"><font color="#00FF33">ONLINE DEFTEC STUDENT FEEDBACK SYSTEM</font> </h1>
        ...
        <div class="row" style="margin-bottom:50px;margin-left:50px">
               ...
               <P><b><u>Student Feedback system for our college.</b></u>
Here we have developed the a faculty feedback system, which is generally to be used in our college DEFTEC to rate the faculty based on the performance...Here we have 2 modules such as administrator, student.
